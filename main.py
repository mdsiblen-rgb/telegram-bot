...
.meth{flex:1;background:#fff;border-radius:14px;padding:10px 6px;text-align:center;cursor:pointer;border:2px solid #ddd;transition:.2s}
.meth.sel{border-width:3px!important;transform:scale(1.05);box-shadow:0 4px 12px rgba(0,0,0,.15)}
...
<span id="appName">প্রতিদিনের কাজ BD</span>
</div>
<span>৳<span id="bTop">0</span></span>
</div>
...
<p>আপনার ব্যালেন্স</p>
<div class="bal-big">৳<span id="bal">0</span></div>
<div class="bal-mini">
<div>আজ দেখেছেন<br><b><span id="adWatched">0</span>/100</b></div>
<div>Refer বোনাস<br><b>৳<span id="refBonus">50</span></b></div>
</div>
<button class="btn" id="earnBtn" style="background:#fff;margin-top:14px" onclick="go('earn')">💰 এখনই আয় করুন</button>
</div>

<div class="card" id="dailyCard">
<div style="display:flex;justify-content:space-between;align-items:center">
<div><b>🎁 Daily Check-in</b><br><small>প্রতিদিন ৳<span id="dailyR">10</span> বোনাস নিন</small></div>
<button class="btn" id="checkinBtn" style="width:auto;padding:10px 18px" onclick="dailyCheck()">বোনাস নিন</button>
</div>
</div>

<div class="card" id="homeNoticeBox" style="background:linear-gradient(135deg,#fef3c7,#fde68a);border:2px dashed #f59e0b;display:none">
<h4 style="margin:0;color:#92400e">📢 অ্যাডমিন নোটিশ - আপনি লিখবেন</h4>
<p id="homeNoticeText" style="margin:8px 0 0;font-weight:bold;color:#78350f;line-height:1.6"></p>
</div>

<div class="card" id="trustCard">
<div style="display:flex;gap:10px;align-items:center">
<div style="background:#dcfce7;padding:10px;border-radius:10px">✅</div>
<div><b>Protidiner Kaj BD Trusted</b><br><small>5000+ User Payment পেয়েছে - 100% Trusted</small></div>
</div>
</div>

<div class="card" style="background:#f0fdf4;text-align:center">
<b>🔥 আজ 127 জন Withdraw করেছে - Live</b>
</div>
</div>

<div id="t-earn" class="tab">
<div class="card">
<h3>📺 কোম্পানি বিজ্ঞাপন - Zone 11764581</h3>
<p>প্রতি Ads ৳<span id="adR">1</span> | Timer 30s | Daily Limit 100</p>
...
<p style="font-size:11px">Watched Today: <span id="adWatched2">0</span> / <span id="adLimit">100</span></p>
</div>
...
<div class="card">
<p>👥 Refer করে আয় - প্রতি Refer ৳<span id="refR">50</span></p>
<p style="font-size:11px;color:#666">আপনার Refer Link:</p>
...
<button class="btn" style="background:#10b981" onclick="navigator.clipboard.writeText(document.getElementById('refLink').innerText);alert('✅ Refer Link Copied!')">Copy Refer Link</button>
</div>
</div>

<div id="t-support" class="tab">
<div class="card">
<h3>🎧 সাপোর্ট সেন্টার - সব লিংক ✅</h3>
...
<button class="btn" style="background:#10b981" onclick="window.open('https://t.me/ProtidinerKajBD','_blank')">💬 Admin এর সাথে Chat</button>
</div>
<div class="card">
<h4>❓ FAQ - প্রশ্ন উত্তর</h4>
<p style="font-size:12px;line-height:1.6">Q: Ad আসে না কেন?<br>A: Telegram App থেকে Open করুন, Zone 11764581 Active।<br><br>Q: Payment কখন?<br>A: প্রতিদিন রাত 8PM - 10PM</p>
</div>
<div class="card" style="background:#f0fdf4;text-align:center"><b>✅ 100% Trusted - 5000+ Payment Done</b></div>
</div>
...
<div class="card">
<h4>💳 পেমেন্ট মেথড - সুন্দর অরিজিনাল লোগো সহ ✅ - FIXED</h4>
<div style="display:flex;gap:10px">
<div onclick="selectMethod('bKash')" id="m-bKash" class="meth sel" style="border-color:#e11d48">
<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/bd/BKash_Logo.png/500px-BKash_Logo.png" style="height:32px;width:auto;display:block;margin:0 auto;object-fit:contain">
<div style="font-weight:bold;color:#e11d48;margin-top:6px;font-size:13px">bKash</div>
<div style="font-size:10px;color:#666">Personal</div>
</div>
<div onclick="selectMethod('Nagad')" id="m-Nagad" class="meth" style="border-color:#f59e0b">
<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/8/87/Nagad_Logo.png/500px-Nagad_Logo.png" style="height:32px;width:auto;display:block;margin:0 auto;object-fit:contain">
<div style="font-weight:bold;color:#f59e0b;margin-top:6px;font-size:13px">Nagad</div>
<div style="font-size:10px;color:#666">Personal</div>
</div>
<div onclick="selectMethod('Rocket')" id="m-Rocket" class="meth" style="border-color:#8b5cf6">
<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/5e/Rocket_Logo.png/500px-Rocket_Logo.png" style="height:32px;width:auto;display:block;margin:0 auto;object-fit:contain">
<div style="font-weight:bold;color:#8b5cf6;margin-top:6px;font-size:13px">Rocket</div>
<div style="font-size:10px;color:#666">Personal</div>
</div>
</div>
<p style="font-size:11px;margin-top:10px;line-height:1.6">⏰ পেমেন্ট টাইম: প্রতিদিন রাত 8PM - 10PM<br>📋 নিয়ম: 1. ভুল Number দিবেন না 2. Min ৳1000 হলে Withdraw</p>
<input type="hidden" id="selectedMethod" value="bKash">
</div>

<div class="card">
<h4>📜 আমার Withdraw History</h4>
<div id="wdHistory"><p style="font-size:11px;color:#888">কোনো Withdraw History নেই - প্রথম Withdraw করুন</p></div>
</div>

<div class="card" style="background:#eff6ff">
<p style="font-size:12px;text-align:center">🔥 আজ 127 জন Withdraw করেছে - Live Payment Proof<br><small>আপনিও আজই Payment পাবেন</small></p>
</div>
</div>

<div class="btm" id="btmBar">
<div onclick="go('home')" id="b-home" class="on">🏠<br>হোম</div>
<div onclick="go('earn')" id="b-earn">📦<br>আয়</div>
<div onclick="go('support')" id="b-support">🎧<br>সাপোর্ট</div>
<div onclick="go('withdraw')" id="b-withdraw">💳<br>উইথড্র</div>
</div>
...
let curSlide=0, slideInt, lastAd=0, curMeth='bKash';
function go(t){
...
function selectMethod(m){
 ...
 document.querySelectorAll('.meth').forEach(e=>{
 ...
 document.getElementById('wNum').placeholder=m+' Personal Number';
}
function initSlider(imgs){
 let box=document.getElementById('sliderBox');
 let dots=document.getElementById('dotsBox');
 if(!imgs||!imgs.length){
  box.innerHTML='<div style="padding:40px;text-align:center;color:#888">No Advertisement</div>';
  return;
 }
 ...
 imgs.forEach((it,i)=>{
  ...
  d.innerHTML=`<img src="${it.img}" onerror="this.src='https://via.placeholder.com/400x200?text=Ad'"><div class="slide-title">${it.title||''}</div>`;
 ...
 slideInt=setInterval(()=>{
  ...
  if(!s.length) return;
  s[curSlide].classList.remove('active');
  ds[curSlide].classList.remove('active');
  curSlide=(curSlide+1)%s.length;
  s[curSlide].classList.add('active');
...
function load(){
 fetch(`/api/get_full?id=${uid}`).then(r=>r.json()).then(d=>{
  if(d.banned){
   document.body.innerHTML="<h2 style='text-align:center;margin-top:50px'>⛔ আপনি Banned</h2>";
   return;
  }
  ...
  document.getElementById('body').style.background=s.bg_color;
  document.getElementById('topBar').style.background=s.banner_color;
  document.getElementById('balCard').style.background=`linear-gradient(135deg,${s.balance_c1},${s.balance_c2})`;
  document.getElementById('adBtn').style.background=s.ad_btn;
  document.getElementById('wdBtn').style.background=s.wd_btn;
  document.getElementById('checkinBtn').style.background=s.checkin_btn;
  document.getElementById('earnBtn').style.color=s.ad_btn;
  document.querySelectorAll('.card').forEach(c=>{
   if(c.id!='homeNoticeBox') c.style.background=s.card_bg;
  });
  ...
  document.getElementById('dailyR').innerText=s.daily_bonus;
  document.getElementById('refLink').innerText=`https://t.me/ProtidinerKaj_BD_Bot?start=${uid}`;
  if(s.home_notice){
   document.getElementById('homeNoticeBox').style.display='block';
   document.getElementById('homeNoticeText').innerText=s.home_notice;
  }
  initSlider(d.slider);
  let tc=document.getElementById('tasksContainer');
  tc.innerHTML='';
  if(d.tasks){
   d.tasks.forEach(t=>{
    tc.innerHTML+=`<div class="task-item"><div><b>${t.title}</b><br><small>৳${t.reward}</small></div><button class="btn" style="width:auto;background:${t.color};padding:8px 14px" onclick="window.open('${t.link}','_blank')">${t.btn}</button></div>`;
   });
  }
 });
}
 ...
 if(typeof show_11764581!=='undefined'){
  show_11764581().then(()=>{
   fetch(`/api/reward?id=${uid}`).then(r=>r.json()).then(d=>{
    alert('✅ ৳'+d.reward+' যোগ হলো - Zone 11764581');
    load();
   });
  });
 } else {
  fetch(`/api/reward?id=${uid}`).then(r=>r.json()).then(d=>{
   alert('Test Reward ৳'+d.reward+' | Telegram App এ Open করলে Real Ad আসবে Zone 11764581');
   load();
  });
 }
}
function doWithdraw(){
 ...
 if(!n||!a) return alert('Number & Amount দাও');
 fetch(`/api/withdraw?id=${uid}&num=${n}&amt=${a}&method=${curMeth}`).then(r=>r.json()).then(d=>alert(d.msg));
}
function dailyCheck(){
 fetch(`/api/daily?id=${uid}`).then(r=>r.json()).then(d=>{
  alert(d.msg); load();
 });
}
load();
...
# ADMIN HTML - FULL BIG
ADMIN_HTML = """
<!DOCTYPE html><html><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1.0"><title>FINAL ADMIN BIG</title>
<style>body{max-width:700px;margin:0 auto;font-family:Arial;background:#f1f5f9;padding:12px}.card{background:#fff;padding:14px;border-radius:12px;margin:12px 0;box-shadow:0 2px 8px rgba(0,0,0,.06)}input{width:100%;padding:10px;margin:5px 0;border-radius:8px;border:1px solid #ddd;box-sizing:border-box}input[type=color]{height:45px;padding:2px}.btn{width:100%;padding:12px;border:none;border-radius:8px;color:#fff;font-weight:bold;background:#1e40af;cursor:pointer;margin-top:6px}.grid{display:grid;grid-template-columns:1fr 1fr;gap:10px}table{width:100%;font-size:12px;border-collapse:collapse}th,td{border:1px solid #ddd;padding:6px;text-align:left}th{background:#f8fafc}</style>
</head><body>
<h2 style="text-align:center">🔥 FINAL BIG ADMIN - 400+ Lines - সব আছে</h2>
<div class="card" style="border:2px solid #f59e0b;background:#fffbeb">
<h3>🎨 সব রং + লোগো + নাম - যে রং চাও দিতে পারবা - FINAL</h3>
<label>App Name - উপরে দেখাবে</label><input id="app_name" placeholder="প্রতিদিনের কাজ BD">
<label>Logo URL - প্রোফাইল লোগো (PNG)</label><input id="logo_url" placeholder="https://cdn-icons...png">
<label>Banner Color - উপরের বার</label><input type="color" id="banner_color">
<label>Background Color - পুরা App Background</label><input type="color" id="bg_color">
<label>Card Background - কার্ডের রং</label><input type="color" id="card_bg">
<div class="grid"><div><label>Balance Card Color 1</label><input type="color" id="balance_c1"></div><div><label>Balance Card Color 2</label><input type="color" id="balance_c2"></div></div>
<div class="grid"><div><label>Ad Button Color</label><input type="color" id="ad_btn"></div><div><label>Withdraw Button Color</label><input type="color" id="wd_btn"></div></div>
<label>Checkin Button Color</label><input type="color" id="checkin_btn">
<label>Home Notice - হোম পেজের নিচে তুমি যা লিখবা বিজ্ঞাপন</label><input id="home_notice" placeholder="🔥 আজ Giveaway">
<button class="btn" style="background:#f59e0b;color:#000" onclick="saveDesign()">💾 সব রং + লোগো + নোটিশ Save করো</button>
</div>
<div class="card" style="border:2px solid #10b981;background:#f0fdf4">
<h3>💰 সব টাকা সেটিং - প্রথম জয়েন বোনাস সহ</h3>
<div class="grid">
<div><label>Welcome Bonus - প্রথম জয়েনে পাবে</label><input id="welcome_bonus" type="number"></div>
<div><label>Ad Reward - প্রতি Ads এ</label><input id="ad_reward" type="number"></div>
<div><label>Refer Bonus</label><input id="ref_bonus" type="number"></div>
<div><label>Min Withdraw - কত হলে তুলতে পারবে</label><input id="min_withdraw" type="number"></div>
<div><label>Daily Bonus - প্রতিদিন</label><input id="daily_bonus" type="number"></div>
<div><label>Ad Zone - 11764581</label><input id="ad_zone"></div>
</div>
<button class="btn" style="background:#10b981" onclick="saveMoney()">💾 টাকার সেটিং Save</button>
</div>
<div class="card"><h3>📊 Dashboard - মোট User, Balance, Withdraw</h3><div id="stats" style="font-weight:bold;line-height:1.6"></div></div>
<div class="card"><h3>👥 User List - কে জয়েন করলো, কত ইনকাম, কত Ads, কত Refer করলো</h3><table><thead><tr><th>User ID</th><th>Balance</th><th>Ads Watched</th><th>Refer Count</th></tr></thead><tbody id="userTable"></tbody></table></div>
<div class="card"><h3>💸 Withdraw List - কে কত টাকা তুললো, কোন মেথডে, Number</h3><table><thead><tr><th>User ID</th><th>Method - bKash/Nagad</th><th>Number</th><th>Amount</th><th>Date</th></tr></thead><tbody id="wdTable"></tbody></table></div>
<div class="card"><h3>🎁 Refer Log - কে কাকে Refer করলো</h3><table><thead><tr><th>Referrer</th><th>New User</th><th>Bonus</th><th>Date</th></tr></thead><tbody id="refTable"></tbody></table></div>
<div class="card"><h3>📢 Slider বিজ্ঞাপন লেখো - Image + Title + Link - তুমি নিজে লেখবা - 3.5s পর পর চলবে</h3><input id="sTitle" placeholder="Title - যেমন 🔥 আজ 5000 টাকা Giveaway"><input id="sImg" placeholder="Image URL - https://...jpg"><input id="sLink" placeholder="Link - https://t.me/ProtidinerKajBD"><button class="btn" onclick="addSlider()">+ Add Slider বিজ্ঞাপন</button><div id="sliderList"></div></div>
<script>
let aid=new URLSearchParams(location.search).get('id')||'8807178385';
function loadAll(){
 fetch(`/api/pro_stats?id=${aid}`).then(r=>r.json()).then(d=>{
  document.getElementById('app_name').value=d.settings.app_name;
  document.getElementById('logo_url').value=d.settings.logo_url;
  document.getElementById('banner_color').value=d.settings.banner_color;
  document.getElementById('bg_color').value=d.settings.bg_color;
  document.getElementById('card_bg').value=d.settings.card_bg;
  document.getElementById('balance_c1').value=d.settings.balance_c1;
  document.getElementById('balance_c2').value=d.settings.balance_c2;
  document.getElementById('ad_btn').value=d.settings.ad_btn;
  document.getElementById('wd_btn').value=d.settings.wd_btn;
  document.getElementById('checkin_btn').value=d.settings.checkin_btn;
  document.getElementById('home_notice').value=d.settings.home_notice||'';
  ...
  document.getElementById('daily_bonus').value=d.settings.daily_bonus;
  document.getElementById('ad_zone').value=d.settings.ad_zone;
  document.getElementById('stats').innerHTML=`মোট User: ${d.total_users} জন<br>মোট Balance: ৳${d.total_balance}<br>মোট Withdraw: ${d.total_withdraws} টা<br>আজ Join: ${d.today_join||0} জন`;
  let ut=document.getElementById('userTable'); ut.innerHTML='';
  d.users.forEach(u=>{ ut.innerHTML+=`<tr><td>${u.id}</td><td>৳${u.balance}</td><td>${u.ads}</td><td>${u.ref_count}</td></tr>`; });
  let wt=document.getElementById('wdTable'); wt.innerHTML='';
  d.withdraws.forEach(w=>{ wt.innerHTML+=`<tr><td>${w.uid}</td><td>${w.method}</td><td>${w.num}</td><td>৳${w.amt}</td><td>${(w.date||'').slice(0,16)}</td></tr>`; });
  let rt=document.getElementById('refTable'); rt.innerHTML='';
  if(d.ref_logs){ d.ref_logs.forEach(r=>{ rt.innerHTML+=`<tr><td>${r.referrer}</td><td>${r.new_user}</td><td>৳${r.bonus}</td><td>${(r.date||'').slice(0,16)}</td></tr>`; }); }
  let sl=document.getElementById('sliderList'); sl.innerHTML='';
  d.slider.forEach((s,i)=>{ sl.innerHTML+=`<div style="border:1px solid #ddd;padding:8px;margin:8px 0;border-radius:10px"><img src="${s.img}" style="width:100%;height:70px;object-fit:cover;border-radius:8px"><p style="font-weight:bold;margin:6px 0">${s.title}</p><button onclick="delS(${i})" style="background:#ef4444;color:#fff;border:none;padding:6px 12px;border-radius:6px;cursor:pointer">Delete</button></div>`; });
 });
}
...
def daily():
    ...
    if d['users'][uid].get('last_daily')==today:
        return jsonify({"ok":False,"msg":"আজকের বোনাস নিয়েছো - কাল আবার নিও"})
    d['users'][uid]['balance']+=d['settings']['daily_bonus']
    d['users'][uid]['last_daily']=today
    save_db(d)
    return jsonify({"ok":True,"msg":f"✅ ৳{d['settings']['daily_bonus']} Daily Bonus যোগ হলো!"})
...
def wd():
    ...
    if d['users'][uid]['balance']<amt: return jsonify({"ok":False,"msg":"Balance কম আছে"})
    if amt<d['settings']['min_withdraw']: return jsonify({"ok":False,"msg":f"Min {d['settings']['min_withdraw']} টাকা লাগবে"})
    d['users'][uid]['balance']-=amt
    d['withdraws'].append({"uid":uid,"num":num,"amt":amt,"method":method,"date":str(datetime.datetime.now())})
    save_db(d)
    return jsonify({"ok":True,"msg":f"✅ {method} - ৳{amt} Withdraw Request পাঠানো হলো!"})
...
def save_design():
    ...
    save_db(d); return jsonify({"ok":True,"msg":"✅ সব রং + লোগো + হোম নোটিশ Save হলো!"})

@app.route('/api/save_money')
def save_money():
    if request.args.get('id')!= str(ADMIN_ID): return jsonify({"ok":False})
    d=load_db(); s=d['settings']
    s['welcome_bonus']=int(request.args.get('welcome_bonus',s['welcome_bonus']))
    s['ad_reward']=int(request.args.get('ad_reward',s['ad_reward']))
    s['ref_bonus']=int(request.args.get('ref_bonus',s['ref_bonus']))
    s['min_withdraw']=int(request.args.get('min_withdraw',s['min_withdraw']))
    s['daily_bonus']=int(request.args.get('daily_bonus',s['daily_bonus']))
    s['ad_zone']=request.args.get('ad_zone',s['ad_zone'])
    save_db(d); return jsonify({"ok":True,"msg":"✅ টাকার সেটিং + Welcome Bonus Save হলো!"})
...
def add_slider():
    ...
    save_db(d); return jsonify({"ok":True,"msg":"✅ Slider Add হলো! 3.5s পর পর চলবে"})
...
def run_bot():
    async def start(u: Update, c: ContextTypes.DEFAULT_TYPE):
        ...
        await u.message.reply_text(f"Welcome {u.effective_user.first_name} ✅\n🎁 {d['settings']['welcome_bonus']} টাকা Welcome Bonus!\nZone 11764581 Ready - Ad দেখো", reply_markup=InlineKeyboardMarkup(kb))
    async def runner():
