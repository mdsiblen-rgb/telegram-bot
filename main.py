    ...
    if not os.path.exists(DB_FILE):
        return {
            ...
            "slider": [
                ...
                {"img": "https://img.freepik.com/free-vector/gradient-refer-friend-banner_23-2149373488.jpg", "link": "https://t.me/ProtidinerKajBD", "title": "💰 Refer করে ৳50"},
            ],
            "settings": {
...
async def start_cmd(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text(f"Welcome {update.effective_user.first_name} ✅\n🎁 {d['settings']['welcome_bonus']} Bonus!", reply_markup=InlineKeyboardMarkup(kb))

def run_bot():
    app_bot = Application.builder().token(BOT_TOKEN).build()
    app_bot.add_handler(CommandHandler("start", start_cmd))
    print("Bot polling started - fixed version")
