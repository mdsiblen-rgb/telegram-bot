...
<div>মোট রেফার: <span id="rc">0</span> জন</div>
</div>
</div>
...
<img src="https://upload.wikimedia.org/wikipedia/commons/d/db/Nagad_Logo.png">
<div style="margin-top:8px;color:#f59e0b;font-size:13px">Nagad</div>
</div>
</div>
...
<div class="prof">
<img src="https://cdn-icons-png.flaticon.com/512/3135/3135715.png" style="width:64px;height:64px;border-radius:50%;background:#fff">
<div style="flex:1">
<div id="pn" style="font-weight:900;font-size:18px"></div>
<div>ID: <span id="pid"></span></div>
<div style="display:flex;gap:6px;margin-top:8px">
<input id="en" placeholder="নতুন নাম লিখুন" style="padding:8px;border-radius:10px;border:none;flex:1;color:#000">
<button onclick="cn()" style="background:#f59e0b;border:none;padding:8px 12px;border-radius:10px;color:#fff;font-weight:700">Edit</button>
</div>
</div>
</div>
<div class="gcard"><span>💼 বর্তমান ব্যালেন্স</span><b>৳<span id="pBal">0</span></b></div>
<div class="gcard"><span>✅ মোট সফল উইথড্র</span><b>৳<span id="ptw">0</span></b></div>
<div class="grid">
<div class="scard"><small>আজকের আয়</small><br><b id="pt">৳0</b></div>
<div class="scard"><small>গতকালের আয়</small><br><b id="py">৳0</b></div>
<div class="scard"><small>মোট Ads দেখা</small><br><b id="pa">0 টি</b></div>
<div class="scard"><small>মোট রেফার</small><br><b id="pr">0 জন</b></div>
</div>
