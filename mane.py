...
<div id="home" class="page active">
  <div class="balbox"><div class="bal">৳ {{c.balance}}</div></div>
  <div class="notice"><div><b>Official Notice</b><br><small>Watch Ads Daily</small></div><div class="live"><div class="dot"></div>LIVE</div></div>
