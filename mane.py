...
</div> <div class='glass'><h4>💸 Withdraw</h4><div style='display:flex;gap:8px;margin-top:10px'><div id='m-bKash' onclick="selM('bKash')" style='flex:1;padding:12px;text-align:center;background:#0B0E1C;border:1px solid #333;border-radius:10px;cursor:pointer'>bKash</div><div id='m-Nagad' onclick="selM('Nagad')" style='flex:1;padding:12px;text-align:center;background:#0B0E1C;border:1px solid #333;border-radius:10px;cursor:pointer'>Nagad</div></div><input id='wNum' placeholder='01XXXXXXXXX' style='margin-top:10px'><input id='wAmt' type='number' placeholder='Min 500 Taka' style='margin-top:8px'><button class='btn' onclick='doWD()' style='margin-top:10px'>Withdraw Now</button></div> <div class='spon-big'><div style='display:flex;justify-content:space-between;margin-bottom:12px'><small style='background:var(--secondary);color:#000;padding:6px 14px;border-radius:10px;font-size:11px;font-weight:900'>🔥 SPONSORED • BIGGEST AD</small><small style='opacity:.5;font-size:10px'>Monetag Active</small></div><b id='sponTitle' style='font-size:20px;display:block;line-height:1.3'>BIG AD!</b><p id='sponDesc' style='font-size:14px;opacity:.9;margin:12px 0 18px;line-height:1.7'>Desc</p><button id='sponBtn' style='width:100%;background:var(--secondary);color:#000;border:none;padding:16px;border-radius:14px;font-weight:900;font-size:15px'>🚀 Explore Now →</button></div>
</div>
