...
<div class='glass'><h4>💸 Withdraw</h4><div style='display:flex;gap:8px;margin-top:10px'><div id='m-bKash' onclick="selM('bKash')" style='flex:1;padding:12px;text-align:center;background:#0B0E1C;border:1px solid #333;border-radius:10px;cursor:pointer'>bKash</div><div id='m-Nagad' onclick="selM('Nagad')" style='flex:1;padding:12px;text-align:center;background:#0B0E1C;border:1px solid #333;border-radius:10px;cursor:pointer'>Nagad</div></div><input id='wNum' placeholder='01XXXXXXXXX' style='margin-top:10px'><input id='wAmt' type='number' placeholder='Min 500 Taka' style='margin-top:8px'><button class='btn' onclick='doWD()' style='margin-top:10px'>Withdraw Now</button></div> <styllele</div> <div class='spon-big'><div style='display:flex;justify-content:space-between;margin-bottom:12px'><small style='background:var(--secondary);color:#000;padding:6px 14px;border-radius:10px;font-size:11px;font-weight:900'>🔥 SPONSORED • BIGGEST AD</small><small style='opacity:.5;font-size:10px'>Monetag Active</small></div><b id='sponTitle' style='font-size:20px;display:block;line-height:1.3'>BIG AD!</b><p id='sponDesc' style='font-size:14px;opacity:.9;margin:12px 0 18px;line-height:1.7'>Desc</p><button id='sponBtn' style='width:100%;background:var(--secondary);color:#000;border:none;padding:16px;border-radius:14px;font-weight:900;font-size:15px'>🚀 Explore Niddiv id='p-tasks' class='page'><div class='glass'><h4>🎯 Tasks & Company Links</h4><p style='font-size:11px;opacity:.6;margin:6px 0'>প্রতি Task এ ৳20-25 + Diamond</p><div id='tList'></div></div></div>iddiv id='p-refer' class='page'>
<div style='margin:12px;background:linear-gradient(135deg,var(--secondary),#f97316);border-radius:16px;padding:14px;text-align:center;color:#000;font-weight:800;font-size:13px' id='refBanner'>🎉 Refer Contest</div>
<div class='glass'><h3 id='refTitle'>👥 Refer & Earn</h3><p id='refDesc' style='font-size:13px;opacity:.7;margin:8px 0'></p><div style='display:flex;gap:8px;margin:12px 0'><div class='stat-box'><b style='font-size:18px;color:var(--primary)' id='rCount'>0</b><br><small>Total Refer</small></div><div class='stat-box'><b style='font-size:18px;color:#22c55e' id='rEarn'>৳0</b><br><small>Earned</small></div><div class='stat-box'><b style='font-size:18px;color:var(--secondary)'>15%</b><br><small>Commission</small></div></div><input id='rLink' readonly style='font-size:11px'><button class='btn' onclick='copyR()'>🔗 Copy Refer Link</button></div>
<div class='glass'><h4>📋 How Refer Works</h4><pre id='refRules' style='white-space:pre-wrap;font-family:system-ui;font-size:13px;opacity:.8;margin-top:8px;line-height:1.6'></pre></div>
